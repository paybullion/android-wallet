...
package com.paybullion.integration.android;
...
public final class BitcoinIntegration
{
	 ...
	 * received by overriding onActivityResult(). Result indicates either
	 ...
	 * overriding onActivityResult(). Result indicates either {@link Activity#RESULT_OK} or
