...
import com.preminer.ui.RequestCoinsActivity;
import com.preminer.ui.SendCoinsActivity;
import com.preminer.ui.SendCoinsQrActivity;
...
public class WalletBalanceWidgetProvider extends AppWidgetProvider
{
			...
			@Nonnull final BigInteger balance)
	{
		...
		for (final int appWidgetId : appWidgetIds)
		{
			...
			views.setTextViewText(R.id.widget_wallet_prefix, config.getPhiPrefix());
