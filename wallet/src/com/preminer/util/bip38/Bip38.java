...
import com.preminer.util.bip38.lambdaworks.SCrypt;
...
public class Bip38 {
    ...
    public static Bip38PrivateKey parseBip38PrivateKey(String bip38PrivateKey) {
        ...
        try {
            decoded = Base58.decodeChecked(bip38PrivateKey);
     ...
     * @throws InterruptedException
     */
    public static byte[] decrypt(String bip38PrivateKeyString, String passphrase, SCryptProgress progressTracker,
    ...
    public static byte[] decryptEcMultiply(Bip38PrivateKey bip38Key, String passphrase, SCryptProgress progressTracker,
                                           NetworkParameters network) throws InterruptedException {
    ...
    public static byte[] decryptNoEcMultiply(Bip38PrivateKey bip38Key, byte[] stretcedKeyMaterial,
