package com.preminer.util.bip38;
...
import com.preminer.util.bip38.ec.Curve;
import com.preminer.util.bip38.ec.EcTools;
import com.preminer.util.bip38.ec.Parameters;
import com.preminer.util.bip38.ec.Point;
import com.preminer.util.bip38.lambdaworks.Base64;
import com.preminer.util.bip38.util.HashUtils;
import com.preminer.util.bip38.util.Sha256Hash;
...
public class SignedMessage {
    ...
    /*
     * to avoid extracting Signature sig twice, the parsed version is also passed in here.
     * it must be obtained from signatureEncoded
     */
...
/*
   public static SignedMessage from(byte[] signature, PublicKey publicKey) {
      ...
      Signature sig = Signatures.decodeSignatureParameters(reader);
      Preconditions.checkState(reader.available() == 0);
      return new SignedMessage(sig, publicKey, recId);
   }
*/
