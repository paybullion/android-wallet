...
import com.preminer.AddressBookProvider;
import com.preminer.Configuration;
import com.preminer.Constants;
import com.preminer.ExchangeRatesProvider;
import com.preminer.ExchangeRatesProvider.ExchangeRate;
import com.preminer.PaymentIntent;
import com.preminer.WalletApplication;
import com.preminer.offline.DirectPaymentTask;
import com.preminer.ui.InputParser.BinaryInputParser;
import com.preminer.ui.InputParser.StreamInputParser;
import com.preminer.ui.InputParser.StringInputParser;
import com.preminer.util.GenericUtils;
import com.preminer.util.Nfc;
import com.preminer.util.WalletUtils;
	...
	private void handleGo()
	{
		...
		new SendCoinsOfflineTask(wallet, backgroundHandler)
		{
			...
			protected void onSuccess(final Transaction transaction)
			{
				...
				transactionHashToResult(result, sentTransaction.getHashAsString());
             ...
             *            transaction hash
             */
            private void transactionHashToResult(final Intent result, final String txHash)
            {
